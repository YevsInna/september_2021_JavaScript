...
//    userDiv.innerText = `${user.name}, age - ${user.age}, status - ${user.status}, address: ${user.address.city}, ${user.address.country},
...
//     userAge.innerText =`Age is ${user.age} years.`;
//     const userStatus = document.createElement('p');
//     userStatus.innerText = `Status - ${user.status}.`;
//     const userAddress = document.createElement('p');
//     userAddress.innerText = `Address: ${user.address.city}, ${user.address.country}, ${user.address.street} street, ${user.address.houseNumber}`
//
//     document.body.appendChild(userDiv);
...
//     userStreet.innerText = `${user.address.street} street`;
//     const userHouse = document.createElement('p');
//     userHouse.innerText = `house number - ${user.address.houseNumber}`;
//
//     document.body.appendChild(userDiv);
//     userDiv.appendChild(userName);
//     userDiv.appendChild(userAge);
...
//     userAddress.appendChild(userCountry);
//     userAddress.appendChild(userStreet);
//     userAddress.appendChild(userHouse);
// };
...
//     liElement.innerText = item.innerText;
